...
function FullPage(k) {
    ...
    if (e && 1 !== H) {
        ...
        D = "ontouchstart" in
            window || window.DocumentTouch && document instanceof DocumentTouch;
        (function () {
        ...
        A.prototype = {
            ...
            solve: function (a, g) {
                return this.sampleCurveY(this.solveCurveX(a,
                    g))
            }
        };
        G = function () {
        ...
        if ("" !== h) {
            for (; V--;) F[V][h + "TransitionTimingFunction"] =
                "cubic-bezier(" + E + "," + O + "," + P + "," + Q + ")";
        ...
        } else W = new A(E, O, P, Q), v = function (a, g, b, c) {
            ...
            switch (!0) {
                case "wheel" === a:
                    U = function (a) {
                        ...
                        t || (a = -a.wheelDelta || a.detail, x(b + (0 >
                            a ? -1 : 1)))
                    };
                ...
                case "touch" === a:
                    ...
                    (function () {
                        ...
                        "Y" === w.transform.translate ? (D = function () {
                            n = F[b - 1];
                            p = F[b + 1];
                            n && (n[h + "TransitionDuration"] = "0ms", n[h + "Transform"] = "translate(0,-" + s + "px) translateZ(0)", n[h + "TransformOrigin"] = "50% 100%",
                            ...
                            var e = Math.abs(b.x / m),
                                K = " scale(" + (a + f * e) + ") rotate(" + (c + d * e) + "deg)";
                            n && 0 < b.x && (console.log(), n.opacity = l + u *
                                e, n[h + "Transform"] = "translate(" + (b.x - m) + "px,0) translateZ(0)" + K);
                            ...
                            0 > d || d > H - 1 ? setTimeout(function () {
                                ...
                                L(b, d), q(e[d], "swipe", "slide"), a.opacity = 1, a[h + "TransitionDuration"] = f + "ms", a[h + "Transform"] = "translate(0,0) translateZ(0)", setTimeout(function () {
                                    q(e[b], "current", "");
                                    q(e[d], "slide", "current");
                                    b = d;
                                    k.callback && k.callback(b, e[b]);
                            ...
                            function (a) {
                                ...
                                switch (k.effect.transform.translate) {
                                    ...
                                    case "X":
                                        ...
                                        break;
                                    default:
                                        c = 350 > +a && 50 < d + b || d > .3 * s || b > .3 * m, d = b > d ? 0 < r.x ? -1 : 1 : 0 < r.y ? -1 : 1
                                }
                        ...
                        B.addEventListener("touchstart",
                            function (a) {
                                a = a.touches[0];
                                t || (t = !0, y = a.pageX, z = a.pageY, G = +new Date, r = {}, A = !1, D(), B.addEventListener("touchmove", v, !1), B.addEventListener("touchend", x, !1))
                            }, !1)
                    })();
                    break;
